...
import { SiMongodb, SiTailwindcss, SiTypescript, SiRedux } from 'react-icons/si';
import { FaReact, FaNode, FaJsSquare, FaCss3Alt, FaHtml5 } from 'react-icons/fa';
...
const Service = () => {
    ...
    const [icons, setIcons] = useState([
        ...
        {
            id: 6, component: <FaHtml5 style={{ background: 'linear-gradient(to right, #e34c26, #f06529)', color: '#fff', }} />
        },
    ...
    return (
        ...
        >
            ...
            <Stack sx={{ flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between' }}>
                ...
                >
                    <Typography variant="body1" color={rootColors.textSecondary} align='left'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid velit veritatis odit
                        officia nostrum eum fugit sint ipsa, cum vitae molestias, corporis quis, totam
                        doloribus deleniti adipisci quidem illo ad!
                    </Typography>
                </Stack>
                <Stack
                    sx={{
                ...
                >
                    <Flipper flipKey={icons.map((icon) => icon.id).join('')}>
                        ...
                        <Stack sx={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 2 }}>
